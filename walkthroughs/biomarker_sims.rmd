...
```{r}
library(rccSims)
plot_cis(stats$rank, ci.nonpar$ci, stats$truth, plot.truth=TRUE) + 
...
Here are the intervals plotted versus rank. Colored points indicate the true value of the parameter.
```{r}
plot_cis(stats$rank, ci.par$ci, stats$truth, plot.truth=TRUE) + 
...
ggsave(h1, file="~/Dropbox/Confidence_Intervals/for_jcgs/img/biomarker.pdf", heigh=4, width=8, units="in", dpi=300)
```
