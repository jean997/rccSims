...
These results are included as a built-in data set to the `rccSims` package.
The `plot_coverage` and `plot_width` functions in the `rccSims` package create plots of the results. 
