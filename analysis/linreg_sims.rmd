---
title: "Linear Regression with Correlated Predictors (Section 3.1)"
...
```{r, gendata, warning=FALSE, message=FALSE}
library(MASS)
library(ggplot2)
library(rcc)
library(rccSims)
...
Next we calculate parametric bootstrap confidence intervals using the usual and block-based ranking schemes. For details on how the `par_bs_ci` function works, see Algorithm 2 and Appendix Algorithm 2 in the paper. You can also refer to the walk-through for section 1.5, [here](compare_cis.html).
...
Next we generate the `ashr` credible intervals of @Stephens2016:
...
ggsave(h1, file="~/Dropbox/Confidence_Intervals/for_jcgs/img/blocks_cov.png", height=4, width=16, units="in", dpi=300)
ggsave(h2, file="~/Dropbox/Confidence_Intervals/for_jcgs/img/blocks_width.png", height=4, width=16, units="in", dpi=300)
ggsave(legend$plot, file="~/Dropbox/Confidence_Intervals/for_jcgs/img/blocks_legend.png", height=1, width=8, units="in", dpi=300)
```
...
h1 <- grid.arrange(covplots[[1]], covplots[[2]], covplots[[3]], covplots[[4]], ncol=4)
h2 <- grid.arrange(widthplots[[1]], widthplots[[2]], widthplots[[3]], widthplots[[4]], ncol=4)
ggsave(h1, file="~/Dropbox/Confidence_Intervals/for_jcgs/img/blocks_cw_cov.png", heigh=4, width=16, units="in", dpi=300)
ggsave(h2, file="~/Dropbox/Confidence_Intervals/for_jcgs/img/blocks_cw_width.png", heigh=4, width=16, units="in", dpi=300)
ggsave(legend$plot, file="~/Dropbox/Confidence_Intervals/for_jcgs/img/blocks_cw_legend.png", height=1, width=5.333, units="in", dpi=300)
```
